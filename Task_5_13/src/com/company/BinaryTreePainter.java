...
public class BinaryTreePainter {
    ...
    private static <T extends Comparable<T>> NodeDrawResult paint(BinaryTree.TreeNode<T> node, Graphics2D g2d, int x, int y) {
        ...
        g2d.setColor(com.company.DrawUtils.getContrastColor(color));
        com.company.DrawUtils.drawStringInCenter(g2d, FONT, node.getValue().toString(), thisX, y, TREE_NODE_WIDTH, TREE_NODE_HEIGHT);
